...
class GameViewController: UIViewController {
    ...
    @IBAction func unwindToGameViewController(segue: UIStoryboardSegue){
        ...
        //After this function is added, drage the segue from your button up to the little orange "EXIT" icon at the top right of your sourceview of the viewcontroller in the Main.storyboard, and you should see the option to "unwindTo[ViewControllerName]WithSegue" i.e. "unwindToGameViewControllerWithSegue"
    }
